...
initialize = function(){
  var latLng = new google.maps.LatLng(47.4666700, -0.5500000); // Correspond au coordonnées d'Angers
  var myOptions = {
...
calculate = function(){
    origin      = document.getElementById('city').value; // Le point départ
    destination = document.getElementById('city2').value; // Le point d'arrivé
